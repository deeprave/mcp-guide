# unbound-session-rendering Specification

## Purpose
Defines the no-project guidance and rendering behavior needed when a session
exists but no project is currently bound.
