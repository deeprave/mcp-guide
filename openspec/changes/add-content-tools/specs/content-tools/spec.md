# Specification: Content Retrieval Tools
...
- **WHEN** pattern matches a document name exactly
- **THEN** return that document

#### Scenario: Pattern as glob
- **WHEN** pattern contains wildcards
- **THEN** match as glob pattern

#### Scenario: Future document argument
- **WHEN** document functionality is implemented
- **THEN** add document argument without breaking existing usage
