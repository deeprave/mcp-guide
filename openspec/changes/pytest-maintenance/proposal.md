...
The suite has grown beyond 2,000 tests, increasing the feedback time for every
...
- Audit every test module against its production behaviour and remove tests
  ...
  existence checks, migration-only coverage, implementation-legacy coverage,
...
- Expected result: fewer, higher-signal tests and shorter full-suite runtime.
