...
Define immutable data models for project configuration using frozen dataclasses with Pydantic validation and functional update patterns.
...
- `categories: List[Category]` - Category configurations
- `collections: List[Collection]` - Collection groupings
- `created_at: datetime` - Creation timestamp
- `updated_at: datetime` - Last update timestamp

### Functional Update Methods
- `with_category(category: Category) -> Project`
- `without_category(name: str) -> Project`
- `with_collection(collection: Collection) -> Project`
- `without_collection(name: str) -> Project`
- `update_category(name: str, updater: Callable) -> Project`
- `update_collection(name: str, updater: Callable) -> Project`
