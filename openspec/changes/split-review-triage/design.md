...
- Triage preserves all source references and versions, deduplicates only the same underlying defect, and preserves recorded triage state when it updates an existing inventory.
