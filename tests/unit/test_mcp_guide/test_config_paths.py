...
def test_get_docroot_resolves_default_user_anchored_config_dir(tmp_path, monkeypatch):
...
def test_get_docroot_resolves_parent_references_in_override(tmp_path, monkeypatch):
