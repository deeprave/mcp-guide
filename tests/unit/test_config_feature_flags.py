...
class TestFeatureFlagsViaSession:
    ...
    async def test_get_global_flags_empty_default(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            session = await create_test_session("test-project", _config_dir_for_tests=temp_dir)
    ...
    async def test_config_persistence(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            session1 = await create_test_session("test-project", _config_dir_for_tests=temp_dir)
            ...
            session2 = await create_test_session("test-project", _config_dir_for_tests=temp_dir)
