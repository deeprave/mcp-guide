...
class TestConfigMigration:
    ...
    def test_migrate_both_categories_and_collections(self):
        ...
        old_data = {
            "categories": [
                {"name": "guide", "dir": "guide/", "patterns": ["guidelines"]}
            ],
            "collections": [
                {"name": "all", "categories": ["guide"], "description": "All"}
            ],
    ...
    def test_migrate_already_dict_format_unchanged(self):
        ...
        dict_data = {
            "categories": {
                "guide": {"dir": "guide/", "patterns": ["guidelines"]}
            },
            "collections": {
                "all": {"categories": ["guide"], "description": "All"}
            }
        }
